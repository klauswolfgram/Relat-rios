...
If lOk
	...
	If MSSeek(xFilial()+MV_PAR01)
	      ...
	      AK1->(dbGoto(nRecAK1))
	   	...
	   	If lOk
			RptStatus( {|lEnd| U_PCOR020Imp(@lEnd,oPrint)})
		EndIf
...
If MsSeek(xFilial()+cOrcame+cRevisa+"001")
	While !Eof() .And. 	AK3_FILIAL+AK3_ORCAME+AK3_VERSAO+AK3_NIVEL==;
		...
		U_PCOR020It(AK3_ORCAME,AK3_VERSAO,AK3_CO)
		dbSelectArea("AK3")
		dbSkip()
	End
EndIf
...
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
ßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßß*/
User Function PCOR020It(cOrcame,cVersao,cCO)
Local aArea		:= GetArea()
