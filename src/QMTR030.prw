...
Static aSM0Data1 := Nil

/*/
ÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜ
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
±±ÚÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄ¿±±
±±³Fun‡…o    ³ QMTR030  ³ Autor ³ Wanderley Goncalves   ³ Data ³ 13.05.98 ³±±
±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄ´±±
±±³Descri‡…o ³ Certificado de Calibracao                                  ³±±
...
±±³              ³        ³      ³  as Escalas (QMR_PREC)                 ³±±
±±³Denis Martins ³18/02/02³Melhor³ Nao permitir impressao do campo data de³±±
±±³              ³        ³      ³ validade quando o mesmo nao apresentar ³±±
±±³              ³        ³      ³ valores no cadastro(Escala Tipo Soma). ³±±
±±³Denis Martins ³20/02/02³Melhor³ Acerto na impressao dos valores de in- ³±±
±±³              ³        ³      ³ certeza do Tipo B.                     ³±±
±±³Denis Martins ³27/03/02³014528³ Impressao dos dados cadastrais de clien³±±
±±³              ³        ³      ³ tes(Endereco/Cidade/Telefone).         ³±±
±±ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ±±
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
ßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßß
/*/
User Function Qmtr030(aImpCer)
...
//ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ
	...
	cText1:=OemToAnsi(STR0002)			//"Neste relat¢rio ser  impresso o Certificado de Calibracao"
	dbSelectArea("QM6")
	dbSetOrder(1)
...
//ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ
	...
	Do While .T.
		...
		Case nOpc==1
			//ÚÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ¿
			//³ Relat¢rio de Certificado de Calibracao                       ³
			//ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ
			U_R030IMP(aImpCer)
			Exit
		Case nOpc==2
...
±±³Fun‡…o    ³ R030Processa ³ Autor ³Wanderley Goncalves³ Data ³ 13/05/98 ³±±
±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄ´±±
±±³Descri‡…o ³ Processamento do QMTR030                                   ³±±
...
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
±±ÚÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄ¿±±
±±³Fun‡…o    ³   A030Mont   ³ Autor ³Wanderley Goncalves³ Data ³ 13/05/98 ³±±
±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄ´±±
...
±±³Fun‡…o    ³R030GetList ³Autor³ Wanderley Goncalves   ³ Data ³ 05.07.98 ³±±
...
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
±±ÚÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄ¿±±
±±³Fun‡…o    ³R030Text    ³Autor³Wanderley Goncalves    ³ Data ³ 13/05/98 ³±±
±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄ´±±
...
/*/
	...
	±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
	±±ÚÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄ¿±±
	±±³Fun‡…o    ³ R030Imp  ³ Autor ³ Wanderley Goncalves   ³ Data ³ 13.05.98 ³±±
	±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄ´±±
	±±³Descri‡…o ³ Certificado de calibra‡„o                                  ³±±
	±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´±±
	±±³Sintaxe   ³ U_R030Imp(void)                                              ³±±
	±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´±±
	±±³ Uso      ³ Generico                                                   ³±±
	±±ÀÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ±±
	±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
...
//ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ
	...
	Local nImpH			// Imprime Texto Historico Instrumento
...
//³ nImpH	:= mv_par09 // Imp.Texto Hist.Ins  :   1-Sim 2-Nao	 |	
//ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ
...
//ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ
	...
	RptStatus({|lEnd| U_MTR030Imp(@lEnd,wnRel,cString,nTxtFin, nInfCom,;
		nInfCIn,nIncs,nIOBS,nILaudo,aImpCer,nIResum,nIItb,nImpH)},Titulo)
Return
...
/*/
	...
	±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
	±±ÚÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄ¿±±
	±±³Fun‡…o    ³ Mtr030Imp³ Autor ³ Alessandro B. Freire  ³ Data ³ 08.04.98 ³±±
	±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄ´±±
	±±³Descri‡…o ³ Certificado de Calibra‡„o                                  ³±±
	±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´±±
	±±³Sintaxe   ³  U_MTR030IMP(void)                                           ³±±
	±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´±±
	...
	ßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßß
/*/
User Function Mtr030Imp(	lEnd, wnRel, cString, nTxtFin, nInfCom, nInfCIn, nIncs, nIOBS, nILaudo,aImpCer,nIResum,nIItb,nImpH)
...
Local cPadraoQMA    := ""
Local cPonto        := ''
Local cQAPCON       := GetMv("MV_QAPCON")
Local cQAPROV       := GetMv("MV_QAPROV")
Local cQCALINC      := GetMv("MV_QCALINC")
Local cQFREQAF      := GetMv("MV_QFREQAF")
Local cQINCRR       := GetMV("MV_QINCRR")
Local cQREPRO       := GetMv("MV_QREPRO")
Local cRevisa       := ""
Local cSeqlQM6      := "00"
Local cStat         := ''
Local cText         := ''
...
Local lImpSub       := .T.
Local lMalha        := .F.
Local lQMR030R      := ExistBlock("QMR030R")
...
//³Caso impressão seja seguida da calibracao.³
...
Do While QM6->(!Eof()) .and. QM6_FILIAL == xFilial("QM6") .and. QM6->QM6_INSTR <= mv_par02
	...
	//³ Se n„o est  entre os periodos informados, n„o imprime.          ³
	...
	//ÚÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ¿
	//³ Procura o instrumento relacionado com o cabe‡alho               ³
	...
	If lQMR030R
		ExecBlock("QMR030R",.F.,.F.,{nTxtFin,nInfCom,nInfCIn,nIncs,nIOBS,nILaudo,nIResum,nIItb,nImpH})
	Else
		m_pag		:=	1
		aPartes[1]	:=	OemToAnsi(QaTit("QM2_INSTR",16,.t.)) + QM2->QM2_INSTR + " - " + QM2->QM2_REVINS
		aPartes[2]	:= 	"-------->> " + OemToAnsi(QaTit("QM6_VALDAF",16,.T.)) + DtoC(QM6->QM6_VALDAF)   // Validade da Afericao
		nSpace		:= (132 - (Len(aPartes[1]) + Len(aPartes[2])))
		Cabec1		:= aPartes[1] + Space(nSpace) + aPartes[2]

		aPartes[1]	:=	OemToAnsi(STR0131) + Alltrim(cUserName)
		aPartes[2]	:=	"-------->> " + OemtoAnsi(STR0023) + Repl(".", 14 - Len(OemToAnsi(STR0023))) + ":    " + RetSem(QM6->QM6_VALDAF) // Semana :
		nSpace		:=	(132 - (Len(aPartes[1]) + Len(aPartes[2])))
		Cabec2		:= aPartes[1] + Space(nSpace) + aPartes[2]
			...
			If lImpDados
				...
				If QMR->(DbSeek(xFilial("QMR")+QM6->QM6_INSTR+QM6->QM6_REVINS))
					...
					Do while cChave ==;
						...
						If QMR->QMR_CAOBRI = "S"
							cInsEsc := U_R030InsEsc(QMR->QMR_INSTR,QMR->QMR_ESCALA)
							If !Empty(cInsEsc)
								lMalha := .T.
...
//
									...
									@ li,122 PSAY Upper(OemToAnsi(QaTit("QM3_INCERT",9)))		// Incerteza
									li++
									@li,000 PSAY __PrtFatLine()
									li++
									lCab := .F.
...
//    X                      X            Y          Y          Z         Z         A
								If lImpSub
									...
									@ li,128 PSAY Left(QM3->QM3_INCERT,10)
									li++
...
//    FAIXA              ESPECIFICADO       TOLER.MIN.       TOLER.MAX.      TP.TOLER.       UNID.MED      INCERTEZA      DT.CALIB.
									...
									Do while QMA->QMA_FILIAL+QMA->QMA_ESCALA+QMA->QMA_REVESC+QMA->QMA_FAIXA ==;
										...
										If lImp
											...
											@ li  ,042 PSAY cTolerQMA
											@ li  ,059 PSAY cTolMaxQMA
											If cTipTol <> "1"
												@ li  ,079 PSAY "%"
											Endif
						...
						@ li,004 PSAY OemToAnsi(STR0030)+DtoC(QM6->QM6_DATA)+space(7)+; //"Data: "
						OemToAnsi(STR0031)+QM6->QM6_TOTHOR+space(7)+; //"Tot.Horas: "
						OemToAnsi(STR0032)+Alltrim(QM6->QM6_RESP) +; // "Metrologista: "
						" - " + Alltrim(Iif(!Empty(QAA->QAA_APELID),QAA->QAA_APELID,QAA->QAA_NOME))

						If (Len(Alltrim(Iif(!Empty(QAA->QAA_APELID),QAA->QAA_APELID,QAA->QAA_NOME)))>20)
                        	aMetrNom := QbrLin(Iif(!Empty(QAA->QAA_APELID),QAA->QAA_APELID,QAA->QAA_NOME),20)
                            nClMetr := Len(OemToAnsi(STR0030)+DtoC(QM6->QM6_DATA)+space(7)+; //"Data: "
									   OemToAnsi(STR0031)+QM6->QM6_TOTHOR+space(7)+; //"Tot.Horas: "
						 			   OemToAnsi(STR0032)+Alltrim(QM6->QM6_RESP) +; // "Metrologista: "
						               " - ")

							For ncMetr := 2 to Len(aMetrNom)
								li++
								@ li,nClMetr+004 PSAY aMetrNom[ncMetr]
							Next ncMetr
											...
											If aMedicoes[nCntFor,nPosGer,1,6] $ "1|2" // Se houver medicoes com incerteza
												...
												If lCab
													If li > 49
														U_R030Cab()
														li++
														U_MTR030CInc(cText,nCntFor)  // Imprime cabecalho de
												...
												ElseIf aMedicoes[nCntFor,nPosGer,1,3] == "A" // Tipo do padrao ‚ Atributo
													...
													If aMedicoes[nCntFor,nPosGer,1,3] $ "O$S$M"
														@li,114 PSAY 	If(aResult[nCntFor,nCntForM,10] == "A" .and. !Empty(aResult[nCntFor,nCntForM,1]),cQAPROV,;
															If(aResult[nCntFor,nCntForM,10] == "R" .and. !Empty(aResult[nCntFor,nCntForM,1]),cQREPRO,;
																"(*)N/A"))
															@li,131 PSAY "|"
														Else
															@li,131 PSAY "|"
															...
															Do while nCont <= aMedicoes[nCntFor,nPosGer,1,1] .and.;
																...
																Else
																	...
																	Else  // Medicoes em relacao ao especificado/limite
																		...
																		EndIf
																		If lCab
																			U_MTR030CEsp(nCntFor,nCntForM) // Imprime cabecalho de Medicoes sem Incerteza
																			lCab := .f.
																			If li > 55
																				U_R030CAB()
																				li++
																		...
																		For nCntFor3 := 1 to aMedicoes[nCntFor,nPosGer,1,1]
																			...
																			If aMedicoes[nCntFor,nPosGer,1,3] $ "O$S$M"
																				...
																				@ li  ,070 PSAY "|"
																				@ li  ,071 PSAY U_R030Dif (SuperVal(aMedicoes[nCntFor,nPosMed,nCntFor3,nCntForM2]),;
																					nCntFor,nLimMin,nLimMax);
																					PICTURE QMT140Pics("aMedicoes[nCntFor,nPosEsp]",aMedicoes[nCntFor,nPosEsp],.f.)
																				@ li  ,082 PSAY "|"
																				@ li  ,083 PSAY U_R030PerDif(SuperVal(aMedicoes[nCntFor,nPosMed,nCntFor3,nCntForM2]),;
																					nCntFor,nLimMin,nLimMax);
																					PICTURE QMT140Pics("aMedicoes[nCntFor,nPosEsp]",aMedicoes[nCntFor,nPosEsp],.f.)
																				...
																				If nTotCol > 1
																					...
																					@ li  ,106 PSAY "|"
																					@ li  ,107 PSAY U_R030Dif (SuperVal(aMedicoes[nCntFor,nPosMed,nCntFor3,nCntForM2+1]),;
																						nCntFor,nLimMin,nLimMax);
																						PICTURE QMT140Pics("aMedicoes[nCntFor,nPosEsp]",aMedicoes[nCntFor,nPosEsp],.f.)
																					@ li  ,116 PSAY "|"
																					@ li  ,117 PSAY U_R030PerDif(SuperVal(aMedicoes[nCntFor,nPosMed,nCntFor3,nCntForM2+1]),;
																						nCntFor,nLimMin,nLimMax);
																						PICTURE QMT140Pics("aMedicoes[nCntFor,nPosEsp]",aMedicoes[nCntFor,nPosEsp],.f.)
																					@ li  ,130 PSAY "|"
																		...
																		If nIOBS == 1 // Se impressao de Texto Final == Sim
																			...
																			Q_MemoArray(cTextRet,axTex,100)
																			...
																			If Len(axTex) > 0
																				...
																				@ li  ,017 PSAY axTex[1]//QA2->QA2_TEXTO
																				@ li  ,131 PSAY "|"
																			...
																			For nx := 2 To Len(axTex)
																				If !empty(axTex[nx]) // para garantir nÆo imprimir uma linha em branco
																					@ li  ,000 PSAY "|"
																					@ li  ,005 PSAY axTex[nx]//QA2->QA2_TEXTO
																					@ li  ,131 PSAY "|"
																					li++
																					If aMedicoes[nCntFor,nPosGer,1,6] $ "1|2" // Se houver medicoes com incerteza
																						If li > 55
																...
																If cEscala <> aMedicoes[nCntFor,nPosEsc]
																	If aMedicoes[If(nCntFor>1,nCntFor-1,1),nPosGer,1,2] = "3" // Imprime o Rodape da Escala para Tipo de Calibracao = Pressao (3)
																		If li > 52
																			...
																			li++
																		EndIf
																		U_MTR030REsP(aRelResu,cEscala,If(nCntFor>1,nCntFor-1,1))
																	ElseIf aMedicoes[If(nCntFor>1,nCntFor-1,1),nPosGer,1,2] = "9" // Imprime o Rodape da Escala para Tipo de Calibracao = Relogio (9)
																		If li > 45
																			U_R030Cab()
																			li++
																		EndIf
																		U_MTR030REsc(aRelResu,cEscala,If(nCntFor>1,nCntFor-1,1))
																	EndIf
																	lCab      := .T.
																	cEscala   := aMedicoes[nCntFor,nPosEsc]
																	nTotCol   := U_r030NumCol(nCntFor)
																EndIf
															Else
														...
														If lImpJust
															...
															dbSelectArea("QA3")
															dbSetOrder(01)
															cTextRet := QA_Rectxt(cChave,"QMTA140L",1,110,"QA3")
															Q_MemoArray(cTextRet,axTex,110)
														...
														For nCntFor := 1 to Len(aMedicoes)
															If !Empty(aMedicoes[nCntFor,nPosIns,1,1])
																...
																For nCntFor2 := 1 to len(aMedicoes[nCntFor,nPosIns])
																	...
																	EndIf
																	If lCab
																		U_CabPadInst("I") // Imprime cabecalho de instrumento utilizado
																		lCab := .f.
																	EndIf
																	li++
																	@ li  ,000 PSAY "|"
																	...
																	If dbSeek(xFilial()+QM6->QM6_INSTR+QM6->QM6_REVINS+DtoS(QM6->QM6_DATA)+cSeql)
																			...
																			If lImpOk
																				...
																				If DbSeek(xFilial("QM6")+aMedicoes[nCntFor,nPosIns,nCntFor2,1]+Inverte(QMI->QMI_REVQPR))
																					...
																					While !QM6->(Eof()) .and. xFilial("QM6")+aMedicoes[nCntFor,nPosIns,nCntFor2,1]+QMI->QMI_REVQPR ==;
																						...
																						If DtoS(QM6->QM6_DATA) <= DtoS(QMI->QMI_DATQPR)
																							nRQM6 := QM6->(RecNo())
																							Exit
																						Endif
																						dbSelectArea("QM6")
																					...
																					If QM6->QM6_DATA <= dData .and. dData <= QM6->QM6_VALDAF .and.;
																						...
																						nRecQM7 := QM7->(Recno()) //QM7_FILIAL+QM7_INSTR+QM7_REVINS+DtoS(QM7_DATA)+QM7_CSEQ+QM7_ESCALA+QM7_REVESC+QM7_PONTO+QM7_REVPAD
																						IF QM7->(DbSeek(xFilial("QM7")+QM6->QM6_INSTR+QM6->QM6_REVINS+DtoS(QM6->QM6_DATA)+QM6->QM6_CSEQ))

																							cChaveQM7 := QM7->QM7_INSTR+QM7->QM7_REVINS+DtoS(QM7->QM7_DATA)+;
																								QM7->QM7_CSEQ+QM7->QM7_ESCALA
																							nRecsQM7 := QM7->(RecNo())
																							nIncert := SuperVal(QM7->QM7_INCERT)
																							Do while cChaveQM7 == QM7->QM7_INSTR+QM7->QM7_REVINS+;
																							...
																							@ li  ,077 PSAY "|"
																							@ li  ,079 PSAY cIncert/* QM7->QM7_INCERT */ //aMedicoes[nCntFor,nPosIns,nCntFor2,3]
																							@ li  ,091 PSAY "|"
																				...
																				Else
																					...
																					@ li  ,131 PSAY "|"
																					lAchou := .T. // Para nao imprimir medicao diferente de ativo.
																				EndIf
																				If !lAchou
																		...
																		Else
																			...
																			Else
																				@ li  ,042 PSAY "|"
																				@ li  ,043 PSAY OemToAnsi(STR0041) //"Medi‡„o exclu¡da"
																				@ li  ,131 PSAY "|"
																			EndIf
																		Endif
																	Else
														...
														For nCntFor := 1 to len(aMedicoes)
															If !empty(aMedicoes[nCntFor,nPosSec,1,1]) //File(cArqQMS)
																...
																For nCntFor2 := 1 to len(aMedicoes[nCntFor,nPosSec])
																	...
																	EndIf
																	If lCab
																		U_CabPadInst("S") // Imprime cabecalho de padroes secundarios
																		lCab := .f.
																		If li > 53
																			U_r030Cab()
																			li++
															...
															If !empty(aMedicoes[nCntFor,nPosNco,1,1])				// File(cArqQMJ)
																If nINCs == 1 // Se impressao de Nao Conformidades == Sim
																	...
																	For nCntFor2 := 1 to Len(aMedicoes[nCntFor,nPosNco])
																		...
																		EndIf
																		If lCab
																			U_CabNaoConf() // Imprime cabecalho de Nao Conformidade
																			lCab := .f.
																			If li > 55
																				U_R030Cab()
																				li++
...
//|   ESCALA           |       PONTO        |   N/C    |                DESCRICAO				  |           CLASSIFICACAO          |
																		...
																		@ li  ,096 PSAY "|"
																		@ li  ,099 PSAY U_MTR030QNC(nCntFor,nPosNco,nCntFor2)
																		@ li  ,131 PSAY "|"
														...
														If nILaudo == 1 // Se impressao do laudo == sim
															...
															If(QM6->QM6_LAUDO=="A",cQAPROV,;
																	If(QM6->QM6_LAUDO=="R",cQREPRO,;
																		cQAPCON))
																	li++
																	cChave := QM6->QM6_CHAVE
																	QA3->(DbSetOrder(1))
																...
																If cQFREQAF == "S"
																	If !empty(QM6->QM6_COND)
																		...
																		If nImpH == 1
																			...
																			For nx := 1 To Len(axTex)
																				...
																				EndIf
																				If nx == 1
																					@ li  ,004 PSAY OemToAnsi(STR0147) // "Informacoes Complementares Historico de Instrumento :"
																					li++
																	...
																	If !Empty(QM2->QM2_CLIE)
																		...
																		Alltrim(GetSM0Vlr("M0_NOME")) + " - " + GetSM0Vlr("M0_NOMECOM")
																		li++
																		...
																		Alltrim(GetSM0Vlr("M0_ENDENT")) + " - " + GetSM0Vlr("M0_CIDENT")
																		li++
																		...
																		Alltrim(GetSM0Vlr("M0_CEPENT")) + " - " + GetSM0Vlr("M0_BAIRENT")
																		li++
...
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
±±ÚÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄ¿±±
±±³Fun‡…o    ³MTR030Carg³ Autor ³ Wanderley Goncalves Jr³ Data ³ 12.05.98 ³±±
±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄ´±±
±±³Descri‡…o ³ Carrega aMedicoes, para calculo dos resultados para impres-³±±
±±³          ³ sao.                                                       ³±±
±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´±±
±±³Sintaxe   ³ U_MTR030Carg()                                               ³±±
±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´±±
±±³ Uso      ³ QMTR030                                                    ³±±
±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´±±
±±³Iuri Seto ³ 20/06/00 ³ Alteracoes para calibrar Tipo de Calibracao Re- ³±±
...
ßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßß
/*/
User Function MTR030Carg(aRelResu,aImpCer)
Local 	nRelResu
Local	aArea := GetArea()
Local   nCntFor2 := 1
...
/*/
	...
	±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
	±±ÚÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄ¿±±
	±±³Fun‡…o    ³R030IMPTXT³ Autor ³ Wanderley Goncalves Jr³ Data ³ 14.05.98 ³±±
	±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄ´±±
	±±³Descri‡…o ³ Imprime Texto do arquivo TXT passado como parametro        ³±±
	±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´±±
	±±³Sintaxe   ³ U_R030IMPTXT(cArq,nTipo)                                     ³±±
	±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´±±
	...
	ßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßß
/*/
User Function R030IMPTXT(cArq,nTipo)
...
/*/
	...
	±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
	±±ÚÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄ¿±±
	±±³Fun‡…o    ³R030CAB   ³ Autor ³ Wanderley Goncalves Jr³ Data ³ 15.05.98 ³±±
	±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄ´±±
...
/*/
	...
	±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
	±±ÚÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄ¿±±
	±±³Fun‡…o    ³CabNaoConf³ Autor ³ Wanderley Goncalves Jr³ Data ³ 18.05.98 ³±±
	±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄ´±±
	±±³Descri‡…o ³ Imprime Cabecalho de Nao Conformidades                     ³±±
	±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´±±
	±±³Sintaxe   ³ U_CabNaoConf()                                               ³±±
	±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´±±
	±±³ Uso      ³ QMTR030                                                    ³±±
	±±ÀÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ±±
	±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
...
/*/
	...
	±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
	±±ÚÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄ¿±±
	±±³Fun‡…o    ³U_R030CM()  ³ Autor ³ Wanderley Goncalves Jr³ Data ³ 19.05.98 ³±±
	±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄ´±±
	...
	Do while nCntFor2 <= Len(aMedicoes)
		If aMedicoes[nCntFor2,nPosGer,1,6] == "1"
			...
			If len(aResult) > 0
				...
				EndIf
				If lCab
					U_CabConfMet() // Imprime cabecalho de Confirmacao Metrologica
					lCab := .f.
				EndIf
				li++
				@ li  ,000 PSAY "|"
...
/*/
	...
	±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
	±±ÚÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄ¿±±
	±±³Fun‡…o    ³MTR030CInc³ Autor ³ Wanderley Goncalves Jr³ Data ³ 20.05.98 ³±±
	±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄ´±±
	±±³Descri‡…o ³ Imprime Cabecalho de Medicoes com Incerteza                ³±±
	±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´±±
	±±³Sintaxe   ³ U_MTR030CINC()                                               ³±±
	±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´±±
	±±³Parametro ³ cText                                                      ³±±
	±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´±±
	±±³ Uso      ³ QMTR030                                                    ³±±
	...
	ßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßß
/*/
User Function MTR030CInc(cText,nLin)
...
/*/
	...
	±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
	±±ÚÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄ¿±±
	±±³Fun‡…o    ³MTR030CEsp³ Autor ³ Wanderley Goncalves Jr³ Data ³ 20.05.98 ³±±
	±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄ´±±
	±±³Descri‡…o ³ Imprime Cabecalho de Medicoes em relacao a valores         ³±±
	±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´±±
	±±³Sintaxe   ³ U_MTR030CEsp()                                               ³±±
	±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´±±
	±±³ Uso      ³ QMTR030                                                    ³±±
	±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´±±
	±±³Iuri Seto ³ 20/06/00 ³ Alteracoes para calibrar Tipo de Calibracao Re- ³±±
	...
	ßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßß
/*/
User Function MTR030CEsp(nLin,nCntForM)
...
/*/
	...
	±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
	±±ÚÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄ¿±±
	±±³Fun‡…o    ³R030Min   ³ Autor ³ Wanderley Goncalves Jr³ Data ³ 20.05.98 ³±±
	±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄ´±±
	±±³Descri‡…o ³ Calcula Valor Minimo                                       ³±±
	±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´±±
	±±³Sintaxe   ³ U_R030Min(nLin)                                              ³±±
	±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´±±
...
/*/
	...
	±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
	±±ÚÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄ¿±±
	±±³Fun‡…o    ³R030Max   ³ Autor ³ Wanderley Goncalves Jr³ Data ³ 20.05.98 ³±±
	±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄ´±±
	±±³Descri‡…o ³ Calcula Valor Minimo                                       ³±±
	±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´±±
	±±³Sintaxe   ³ U_R030Max(nLin)                                              ³±±
	±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´±±
	±±³Parametro ³ nLin -> Linha no aMedicoes                                 ³±±
	±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´±±
	±±³ Uso      ³ QMTR030                                                    ³±±
...
/*/
	...
	±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
	±±ÚÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄ¿±±
	±±³Fun‡…o    ³R030Dif   ³ Autor ³ Wanderley Goncalves Jr³ Data ³ 20.05.98 ³±±
	±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄ´±±
	±±³Descri‡…o ³ Calcula Diferenca entre Valor Encontrado e Nominal ou      ³±±
	±±³          ³ limites                                                    ³±±
	±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´±±
	±±³Sintaxe   ³ U_R030Dif(nLin,nMin,nMax)                                    ³±±
	±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´±±
	...
	ßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßß
/*/
User Function R030Dif(nVal,nLin,nMin,nMax)
...
/*/
	...
	±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
	±±ÚÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄ¿±±
	±±³Fun‡…o    ³R030PerDif³ Autor ³ Wanderley Goncalves Jr³ Data ³ 20.05.98 ³±±
	±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄ´±±
	±±³Descri‡…o ³ Calcula Diferenca entre Valor Encontrado e Nominal ou      ³±±
	±±³          ³ limites em percentual                                      ³±±
	±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´±±
	±±³Sintaxe   ³ U_R030PerDif(nVal,nLin,nMin,nMax)                            ³±±
	±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´±±
	±±³Parametro ³ nVal -> Valor Informado na Medicao                         ³±±
	±±³          ³ nLin -> Linha de posicao no aMedicoes                      ³±±
	±±³          ³ nMin -> Limite Minimo (para calculo c/relacao aos limites) ³±±
	...
	ßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßß
/*/
User Function R030PerDif(nVal,nLin,nMin,nMax)
...
/*/
	...
	±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
	±±ÚÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄ¿±±
	±±³Fun‡…o    ³R030NumCol³ Autor ³ Wanderley Goncalves Jr³ Data ³ 22.08.99 ³±±
	±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄ´±±
	±±³Descri‡…o ³ Retorna numero de colunas de medições                      ³±±
	±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´±±
	±±³Sintaxe   ³ U_R030NumCol()                                               ³±±
	±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´±±
	...
	ßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßß
/*/
User Function R030NumCol(nCntFor)
...
/*/
	...
	±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
	±±ÚÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄ¿±±
	±±³Fun‡…o    ³R030AnaUP ³ Autor ³ Wanderley Goncalves Jr³ Data ³ 03.09.99 ³±±
	±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄ´±±
	±±³Descri‡…o ³ Impressao da Analise das Ultimas Pecas Produzidas          ³±±
	±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´±±
	±±³Sintaxe   ³ U_R030AnaUP()                                                ³±±
	±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´±±
	±±³Parametro ³                                                            ³±±
...
/*/
		...
		±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
		±±ÚÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄ¿±±
		±±³Fun‡…o    ³r030ITB   ³ Autor ³ Antonio Aurelio       ³ Data ³ 03.04.00 ³±±
		±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄ´±±
...
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
±±ÚÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄ¿±±
±±³Fun‡…o    ³r030Traco ³ Autor ³ XXXXXXXXXXXXXXXXXXXXXX³ Data ³ 99.99.99 ³±±
±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄ´±±
±±³Descri‡…o ³ Centraliza o titulo na pag. e preenche com tra‡o a linha.  ³±±
±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´±±
±±³ Uso      ³ QMTR030                                                    ³±±
±±ÀÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ±±
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
...
/*/
					...
					±±³Fun‡…o    ³MTR030SubCab³ Autora³ Iuri Seto            ³ Data ³ 05/06/00³±±
...
/*/
	...
	±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
	±±ÚÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄ¿±±
	±±³Fun‡„o	 ³R030InsMal³ Autora³ Iuri Seto           	³ Data ³ 15/05/00 ³±±
	±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄ´±±
	±±³Descri‡„o ³ Retorna o Codigo do Instrumento que se refere a Malha      ³±±
	±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´±±
	...
	ßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßß
/*/
User Function R030InsEsc(cInstr,cEscala)
...
/*/
	...
	±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
	±±ÚÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄ¿±±
	±±³Fun‡…o    ³MTR030REsc³Autora ³ Iuri Seto             ³ Data ³ 21/06/00 ³±±
	±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄ´±±
	±±³Descri‡…o ³ Imprime Rodape para Tipo de Calibracao Relogio             ³±±
	±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´±±
	±±³Sintaxe   ³ U_MTR030REsc()                                               ³±±
	±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´±±
	...
	ßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßß
/*/
User Function MTR030REsc(aRelResu,cEscala,nCntFor)
	Local nIndice
...
/*/
	...
	±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
	±±ÚÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄ¿±±
	±±³Fun‡…o    ³MTR030REsP³Autora ³ Iuri Seto             ³ Data ³ 21/06/00 ³±±
	±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄ´±±
	±±³Descri‡…o ³ Imprime Rodape para Tipo de Calibracao Pressao             ³±±
	±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´±±
	±±³Sintaxe   ³ U_MTR030REsP()                                               ³±±
	±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´±±
	±±³Parametro ³ nCntFor, nCntForM                                          ³±±
	±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´±±
	±±³ Uso      ³ QMTR030                                                    ³±±
	...
	ßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßß
/*/
User Function MTR030REsP(aRelResu,cEscala,nCntFor)
	Local nIndice
...
±±ºPrograma  ³MTR030QNC ºAutor  ³Cicero Cruz         º Data ³27/10/2005   º±±
±±ÌÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍ¹±±
±±ºDesc.     ³Recupera a Descrição da Classe de Não Conformidade          º±±
±±º          ³                                                            º±±
±±ÌÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ¹±±
±±ºUso       ³ QMTR030 / QMTR140                                          º±±
±±ÈÍÍÍÍÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ¼±±
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
ßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßß
*/
User Function MTR030QNC(nCntFor,nPosNco,nCntFor2)
	Local aArea   := GetArea()
	Local cQNC    := ""
	Local cIdioma := __LANGUAGE //__LANGUAGE ultilizada no QAXFUN

	dbSelectArea("QEE")
	dbSetOrder(1)
	If QEE->(dbSeek(xFilial("QEE")+aMedicoes[nCntFor,nPosNco,nCntFor2,3]))
...
/*/{Protheus.doc} GetSM0Vlr
Retorna conteúdo do cadastro de Empresas do Protheus
@type function 
@author brunno.costa
@since  30/09/2022
@param 01 - cCampo, caracter, campo da SM0 para retornar conteúdo
@return xReturn, variável, conteúdo variável do campo para retorno
/*/
Static Function GetSM0Vlr(cCampo)
	Local xReturn := Nil
	Local nPosCpo := -1
	aSM0Data1 := Iif(aSM0Data1 == Nil, FWSM0Util():GetSM0Data( cEmpAnt , cFilAnt , { "M0_NOME", "M0_NOMECOM", "M0_ENDENT", "M0_CIDENT", "M0_CEPENT", "M0_BAIRENT", "M0_TEL"  } ), aSM0Data1)
	nPosCpo   := aScan(aSM0Data1,{ |x| x[1] == cCampo})
	xReturn   := Iif(nPosCpo > 0, aSM0Data1[nPosCpo, 2], Nil)
Return xReturn


/*/{Protheus.doc} QbrLin
Função Memo To Array, que quebra um texto em um array conforme número de colunas
@author Jamer Pedroso 
@since 19/08/2023
@version 1.0
    @param cTexto, Caracter, Texto que será quebrado (campo MEMO)
    @param nLen, Numérico, Coluna máxima permitida de caracteres por linha
    @return aTexto, Número de linhas do array
    @example
    cCampoMemo := SB1->B1_DESC 
    nCol        := 200
    aDados      := zMemoToA(cCampoMemo, nCol)
    @obs Difere da MemoLine(), pois já retorna um Array pronto para impressão
/*/
 
Static Function QbrLin(cTexto, nLen)
    ...
    //Quebrando
    For nAtu:=1 To Len(cTexto)
        nAuxC++ 
		if nAuxC = nLen
			aadd(aTexto,Substr(cTexto,iif(nAux==1,1,nAux+1),nLen))
			nAux := nAtu
			nAuxC := 0 
		Endif 
    Next

    if Len(aTexto) > 0 .and. nAux < Len(cTexto)
		aadd(aTexto,SubStr(cTexto,nAux+1,nAtu))
	Endif
