...
If AK3->( MsSeek(xFilial()+cOrcame+cRevisa+"001") )
	While AK3->( !Eof() .And. AK3_FILIAL+AK3_ORCAME+AK3_VERSAO+AK3_NIVEL ==;
		...
		U_PCOR050_It(AK3->AK3_ORCAME,AK3->AK3_VERSAO,AK3->AK3_CO)
		AK3->(dbSkip())
	EndDo
EndIf
...
oReport := TReport():New( cReport, cTitulo, cPerg, { |oReport| If( R050Avalia( @cRevisa, cPerg ), U_PCOR050Prt( oReport, cRevisa ), NIL ) }, STR0020 ) // "Este relatorio ira imprimir a Planilha Orçamentária de acordo com os parâmetros solicitados pelo usuário. Para mais informações sobre este relatorio consulte o Help do Programa ( F1 )."
...
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
ßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßß*/
User Function PCOR050Prt( oReport, cRevisa )
...
Processa( { || U_PCOR050Proc( @cArqConta, @cArqTotal, cRevisa ) },, STR0021 )	//"Processando totalizadores da planilha..."
...
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
ßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßß*/
User Function PCOR050_It(cOrcame,cVersao,cCO)
Local aArea		:= GetArea()
...
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
ßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßß*/
User Function PCOR050It(cOrcame,cVersao,cCO)
Local aArea		:= GetArea()
Local aAreaAK3	:= AK3->(GetArea())
...
If MsSeek(xFilial()+cOrcame+cVersao+cCO)
   	While !Eof() .And. AK3->AK3_FILIAL+AK3->AK3_ORCAME+AK3->AK3_VERSAO+AK3->AK3_PAI==xFilial("AK3")+cOrcame+cVersao+cCO
		U_PCOR050It(AK3_ORCAME,AK3_VERSAO,AK3_CO)
		dbSelectArea("AK3")
		dbSkip()
	End
EndIf
