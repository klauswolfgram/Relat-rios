...
If GetRpoRelease() >= "12.1.2410"
	cExpData := "20260331"
	lRetMsg  := PCPExpSV(cExpData,"MATR820", "PCPR820")
EndIf
...
TRCell():New(oSection3,'H1_DESCRI'	,'SH1',/*Titulo*/,/*Picture*/,/*Tamanho*/,/*lPixel*/,/*{|| code-block de impressao }*/,/*cAlign*/,.T.)
...
TRCell():New(oSection4,'VldFinal'   ,'SH8',STR0075,'@!', 10,/*lPixel*/,/*{|| code-block de impressao }*/,/*cAlign*/,.T.) //"Validade Final"
...
WHERE SC2.C2_FILIAL = %xFilial:SC2% AND
	  SC2.C2_NUM || SC2.C2_ITEM || SC2.C2_SEQUEN >= %Exp:cWhere01% AND
	  SC2.C2_NUM || SC2.C2_ITEM || SC2.C2_SEQUEN <= %Exp:cWhere02% AND
