...
Local lFirst    := .T.
Local lTransEnd := .T.
Local lFormTab  := oReport:nDevice == 4 .And. (oReport:nExcelPrintType == 3 .Or. oReport:nExcelPrintType == 4)
