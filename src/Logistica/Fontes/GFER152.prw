...
@description
Relatório de Ocupação de Veículos por Filial,
Mostra o aproveitamento da capacidade dos veículos por Filial pela carga embarcada

-------------------------------------------------------------*/
User Function GFER152()
	Local oReport
	Local aArea := GetArea()
...
Static Function ReportDef()
	...
	//| "                                                                        | "
	//+--------------------------------------------------------------------------+
	oReport := TReport():New("GFER152","Relatório de Ocupação de Veículo por Filial","GFER152", {|oReport| ReportPrint(oReport)},"Emite relatório de Ocupação de Veículos por Filial conforme os parâmetros informados."/*Descricao do relatório*/)
	...
	EndIf
	oSection := TRSection():New(oReport,"Ocupação de Veículos",{"(cAliasOc)"},{"Ocupação de Veículos por Filial"}/*{Array com as ordens do relatório}*/,/*Campos do SX3*/,/*Campos do SIX*/)
...
A funcao estatica CriaTabTemp Cria a struct dos dados do relatório e cria as tabelas temporárias, privadas em U_GFER152() 
