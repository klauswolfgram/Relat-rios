...
±±³Fun‡…o	 ³ Ctbr581	³ Autor ³ José Lucas	 		³ Data ³ 26.04.10 ³±±
±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄ´±
±±³Descri‡…o ³ Demonstracao de Resultados por Centro de Custos.			   ³±
...
/*/
User Function CtbR581()          

Private dFinalA
Private dFinal
Private nomeprog	:= "CTBR581"    
Private dPeriodo0
...
±±³Fun‡…o	 ³ CTBR581R4 ³ Autor ³ José Lucas	 		³ Data ³ 26.04.10 ³±±
...
ßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßß
/*/
User Function CTBR581R4()                           

Private cPerg := "CTR581"        
...
±±³Programa  ³ReportDef  ³ Autor ³ José Lucas	 		³ Data ³ 26.04.10 ³±±
...
±±³Programa  ³ReportPrint ³ Autor ³ José Lucas	 		³ Data ³ 26.04.10 ³±±
...
MsgMeter({|	oMeter, oText, oDlg, lEnd | ;
			CTGerPlan(	oMeter,;
						...
						nDivide,;                                                                                        						
						lVlrZerado,,,,,,,,,,,,,,,,,,,,,,,,,;                                 						
						mv_par07,; //cMoedaDesc,; //alterei
						lMovPeriodo)},STR0006, STR0001) //"Criando Arquivo Temporario..."
...
If Empty(mv_par06)	//Imprime relatório independente da Visão
	...
	cArqTmp1 := CriaTrab(, .F.)
	IndRegua( "cArqTmp", cArqTmp1, "GRUPO+CONTA+CUSTO+ITEM+CLVL",, cFiltroTmp1, OemToAnsi(STR0001) )  //"Selecionando Registros..."
	...
	Do While !Eof() .And. !oReport:Cancel() //.And. Eval(bCond)
		...
		Do While !Eof() .And. !oReport:Cancel() .And. cArqTmp->GRUPO == cGrupo
	    	...
	    	nSaldoAtu := R581Soma("1")      
    		nSaldoAnt := R581Soma("2")
		...
		If lTotGrupo
			If ( cGrupo <> cArqTmp->GRUPO )
				...
				oSection1:Cell("CONTA"):SetBlock( { || OemToAnsi("TOTAL DA NATUREZA")+" ("+cGrupo+") " } )									
...
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
±±ÚÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄ¿±±
±±³Funcao    ³CTR581ESP ³ Autor ³ José Lucas	 		³ Data ³ 26.04.10 ³±±
±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄ´±±
...
ßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßß
/*/
User Function CTR581Esp(oPrint,cDescMoeda,aPosCol,nTamLin)
...
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
±±ÚÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄ¿±±
±±³Funcao    ³CTR581ATU ³ Autor ³ José Lucas	 		³ Data ³ 26.04.10 ³±±
±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄ´±±
±±³Descricao ³Cabecalho para impressao apenas da coluna de Saldo Atual.   ³±±
±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´±±
±±³Sintaxe   ³U_CTR581ESP(ParO1,ParC1)			                          ³±±
±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´±±
±±³Parametros³ ExpO1 = Objeto oPrint                                      ³±±
±±³          ³ ExpC1 = Descricao da moeda sendo impressa                  ³±±
±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´±±
...
ßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßß
/*/
User Function CTR581ATU(oPrint,cDescMoeda,aPosCol,nTamLin)
...
±±ºPrograma  ³R581Soma	³ Autor ³ José Lucas	 		³ Data ³ 26.04.10 ³±±
...
Static Function R581Soma(cTipoSaldo)
